...
| 工具 ID | EN H1 | ZH H1 | EN SEO title | ZH SEO title | EN meta description | ZH meta description | EN card description | ZH card description |
|---|---|---|---|---|---|---|---|---|
| `ai-prompt-generator` | AI Image Prompt Generator | AI 绘画提示词生成器 | AI Image Prompt Generator for Midjourney and Stable Diffusion | AI 绘画提示词生成器：Midjourney 和 Stable Diffusion 提示词 | Turn short image ideas into structured English prompts for Midjourney, Stable Diffusion, DALL-E, and other image models. | 输入简短画面想法和风格，生成可复制的英文绘图提示词，用于 Midjourney、Stable Diffusion 等图像模型测试。 | Expand a visual idea into copy-ready English prompts with style, scene, lighting, and composition details. | 把画面想法整理成多套英文绘图提示词，便于复制到图像模型测试。 |
| `ai-video-script` | AI Video Script Generator | AI 视频脚本生成器 | AI Video Script Generator for Short Videos | AI 视频脚本生成器：短视频分镜、口播和字幕 | Generate short-form video scripts with hooks, scenes, captions, voiceover notes, and CTA ideas for TikTok, Reels, Shorts, and YouTube. | 输入视频主题、平台、时长和语气，生成开场钩子、分镜段落、口播、字幕提示和行动号召。 | Create short-video scripts with hook, scene structure, captions, voiceover, and CTA notes. | 把视频主题整理成短视频脚本草稿，包含钩子、分镜、字幕和 CTA。 |
| `ai-text-polisher` | AI Text Polisher | AI 文本润色工具 | AI Text Polisher for Clearer Emails, Posts, and Copy | AI 文本润色工具：邮件、帖子和商品文案改写 | Rewrite rough text into clearer, cleaner copy while preserving the original meaning, facts, and intended tone. | 粘贴粗糙文本并选择语气，改写成更清楚、更顺的版本，同时保留原意、事实和关键术语。 | Polish emails, posts, product copy, and notes without changing the core message. | 把邮件、帖子、商品文案和备注改写得更清楚，同时保留核心意思。 |
| `ai-translator` | AI Translator | AI 翻译工具 | AI Translator with Tone and Context Control | AI 翻译工具：按语气翻译邮件和商品文案 | Translate text with tone control for emails, product copy, social posts, documents, and everyday writing. | 粘贴原文并选择目标语言和语气，生成可复制译文，适合邮件、商品文案、社媒内容和日常沟通。 | Translate text and adapt tone while keeping structure and context. | 按目标语言和语气翻译文本，适合邮件、商品文案和日常沟通。 |
| `ai-excel-formula` | AI Excel Formula Generator | AI Excel 公式生成器 | AI Excel Formula Generator for Sheets and Excel | AI Excel 公式生成器：Excel 和 Google Sheets 公式 | Describe a spreadsheet task and generate Excel or Google Sheets formulas with usage notes and examples. | 描述表格任务，生成 Excel 或 Google Sheets 公式，并附简短解释和使用提醒。 | Generate spreadsheet formulas from plain-language requirements. | 用自然语言生成 Excel 或 Google Sheets 公式，并查看简短解释。 |
| `ai-regex` | AI Regex Generator | AI 正则生成器 | AI Regex Generator with Examples and Explanations | AI 正则生成器：匹配规则、示例和解释 | Describe a matching rule and generate a regex pattern with test examples, flags, and key syntax notes. | 描述匹配或排除规则，生成正则表达式、测试样例和简短语法解释。 | Create regex patterns from matching requirements, with examples and explanations. | 根据匹配需求生成正则表达式，并附测试样例和语法说明。 |
| `ai-xiaohongshu` | Xiaohongshu Caption Generator | 小红书文案生成器 | Xiaohongshu Caption Generator for Product and Lifestyle Posts | 小红书文案生成器：产品种草和生活方式笔记 | Generate Xiaohongshu post titles, body copy, emoji suggestions, and hashtags from a topic, audience, and selling points. | 输入主题、关键词和笔记风格，生成小红书标题方向、正文草稿、话题标签和互动引导。 | Draft Xiaohongshu post copy with title, body, emoji, and hashtag ideas. | 根据主题和关键词生成小红书标题、正文、话题标签和互动引导。 |
| `ai-resume-optimizer` | AI Resume Optimizer | AI 简历优化工具 | AI Resume Optimizer for Job Applications | AI 简历优化工具：岗位投递简历改写 | Rewrite resume text against a job description, improve structure, preserve facts, and produce a copy-ready resume draft. | 输入简历文本和目标岗位 JD，生成更清楚、更贴近岗位的简历草稿。 | Improve resume wording and structure from source resume text and a target job description. | 根据简历文本和岗位 JD 优化表达、结构和关键词。 |
| `competitor-tracker` | Ecommerce Competitor Tracker | 电商竞品分析器 | Ecommerce Competitor Tracker for Listing Gaps | 电商竞品分析器：Listing 差异和卖点机会 | Compare your product with competitor listings and identify gaps in positioning, benefits, copy, and offer strategy. | 输入你的产品和竞品信息，对比卖点、弱项、文案机会和产品改进方向。 | Compare competitor listings and find positioning, copy, and offer gaps. | 对比你的产品和竞品，找出卖点差异、弱项和文案机会。 |
| `market-insights` | Ecommerce Market Insights Generator | 电商市场洞察工具 | Ecommerce Market Insights Generator for Product Ideas | 电商市场洞察工具：产品想法和品类研究笔记 | Generate market notes for a platform, category, trend, or product idea. Use the output as research notes, not live market data. | 输入平台、品类或产品想法，生成市场研究笔记、机会点、风险提醒和验证建议。 | Draft category and product opportunity notes from a platform or product idea. | 把平台或产品想法整理成市场研究笔记和下一步验证清单。 |
