...
Run the exact order in the [Etsy Fee Calculator](/tools/ecommerce/etsy-fee-calculator) before assuming your shipping charge fully covers postage.
...
If your shop is above the $10,000 threshold and cannot opt out, model ad-attributed orders with the [Etsy Offsite Ads Calculator](/tools/ecommerce/etsy-offsite-ads-calculator) before choosing a shipping structure.
...
1. Measure the packed product, not just the product itself.
2. Calculate actual shipping cost to several common buyer locations (nearby, opposite coast, international).
3. Include packaging and handling cost in your shipping model.
4. Model Etsy fees on the full buyer-paid amount — transaction fee, payment processing, and possible ad fees.
5. Test free, partial, and full buyer-paid shipping with the [Etsy Pricing Calculator](/tools/ecommerce/etsy-pricing-calculator).
6. Check whether Offsite Ads would make the strategy unprofitable using the [Etsy Offsite Ads Calculator](/tools/ecommerce/etsy-offsite-ads-calculator).
7. Set up organized shipping profiles by item weight class.
8. Decide on insurance policy — insure, self-insure, or carrier-provided coverage.
9. Write clear delivery expectations and customs duty disclaimers in the listing description.
10. Review carrier rates and shipping profiles quarterly.
...
*Helpful tools: compare scenarios with the [Etsy Pricing Calculator](/tools/ecommerce/etsy-pricing-calculator), audit fees with the [Etsy Fee Calculator](/tools/ecommerce/etsy-fee-calculator), and stress-test ad-attributed orders with the [Etsy Offsite Ads Calculator](/tools/ecommerce/etsy-offsite-ads-calculator).*

**Further reading from Etsy:** [How to Ship Your Items on Etsy](https://help.etsy.com/hc/en-us/articles/360035901534-How-to-Ship-Your-Items-on-Etsy), [How to Offer Free Delivery](https://help.etsy.com/hc/en-gb/articles/360024198553-How-to-Offer-Free-Delivery), and [Fees & Payments Policy](https://www.etsy.com/legal/fees/).
