...
export const AI_TOOL_OVERVIEWS: Record<string, BilingualOverview> = {
  ...
  'ai-svg-generator': {
    ...
    en: {
      ...
      input:
        'Two core inputs shape the result: graphic description and target style. Describe the subject, design purpose, display size, shape language, stroke weight, color direction, background, complexity, and any special requirements such as symmetry or tiling. Target styles include Flat Design, Line Art, Minimalist, and Colorful. The more specific the description, the easier it is to get an SVG draft that can be used or edited.',
      output:
