...
- Utility tools: QR generator, QR scanner, barcode generator, unit converter, time converter, archive converter, RMB uppercase converter, PPI calculator, BMI calculator, password generator, short URL converter.
