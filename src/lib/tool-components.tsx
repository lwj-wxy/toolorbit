...
export const toolComponentMap: Record<string, ToolComponent> = {
  ...
  '/tools/calculate/reverse-vat-calculator': lazyTool(() => import('../views/tools/calculate/ReverseVatCalculator')),
  ...
  '/tools/calculate/uk-vat-calculator': lazyTool(() => import('../views/tools/calculate/UkVatCalculator')),
  '/tools/calculate/vat-inclusive-exclusive-calculator': lazyTool(() => import('../views/tools/calculate/VatInclusiveExclusiveCalculator')),
