...
export const toolComponentMap: Record<string, ToolComponent> = {
  ...
  '/tools/ecommerce/etsy-tag-generator': lazyTool(() => import('../views/tools/ecommerce/EtsyTagGenerator')),
  '/tools/ecommerce/etsy-free-shipping-calculator': lazyTool(() => import('../views/tools/ecommerce/EtsyFreeShippingCalculator')),
