...
export const toolComponentMap: Record<string, ToolComponent> = {
  ...
  '/tools/ai/weekly-report-generator': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  ...
  '/tools/ai/excel-formula': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  '/tools/ai/regex': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  ...
  '/tools/ai/xiaohongshu': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  '/tools/ai/text-polisher': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  '/tools/ai/translator': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  ...
  '/tools/ai/competitor-tracker': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  '/tools/ai/market-insights': lazyTool(() => import('../views/tools/ai/P1RuntimeTool')),
  ...
  '/tools/ecommerce/vat-inclusive-exclusive-calculator': lazyTool(() => import('../views/tools/calculate/VatInclusiveExclusiveCalculator')),
  ...
  '/tools/utility/mbti-personality-test': lazyTool(() => import('../views/tools/utility/MbtiPersonalityTest')),
