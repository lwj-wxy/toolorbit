...
const RAW_TOOLS_META = [
  ...
  },
  {
    ...
    description: 'Improve resume wording and structure from source resume text and a target job description.',
    category: 'AI 工具',
  ...
  },
  {
    ...
    description: 'Generate spreadsheet formulas from plain-language requirements.',
    category: 'AI 工具',
  ...
  },
  {
    ...
    description: 'Create regex patterns from matching requirements, with examples and explanations.',
    category: 'AI 工具',
    path: '/tools/ai/regex',
    color: 'indigo',
    isPopular: false,
  ...
  {
    id: 'ai-xiaohongshu',
    name: 'Xiaohongshu Caption Generator',
    description: 'Draft Xiaohongshu post copy with title, body, emoji, and hashtag ideas.',
    category: 'AI 工具',
  ...
  },
  {
    ...
    description: 'Polish emails, posts, product copy, and notes without changing the core message.',
    category: 'AI 工具',
  ...
  },
  {
    id: 'ai-translator',
    name: 'AI Translator',
    description: 'Translate text and adapt tone while keeping structure and context.',
    category: 'AI 工具',
  ...
  },
  {
    ...
    name: 'Ecommerce Competitor Tracker',
    description: 'Compare competitor listings and find positioning, copy, and offer gaps.',
    category: 'AI 工具',
  ...
  {
    id: 'market-insights',
    name: 'Ecommerce Market Insights Generator',
    description: 'Draft category and product opportunity notes from a platform or product idea.',
    category: 'AI 工具',
