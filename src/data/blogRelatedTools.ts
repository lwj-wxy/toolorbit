export const BLOG_RELATED_TOOLS: Record<string, string[]> = {
  ...
  "codex-gpt-image-2-workflow": [
    "/tools/ai/prompt-generator",
    "/tools/image/image-compressor",
    "/tools/image/image-converter",
  ],
  "codex-skill-installation-guide": [
    "/tools/dev/json-formatter",
    "/tools/dev/text-diff",
    "/tools/ai/prompt-generator",
  ],
  "codex-ui-ux-pro-max-guide": [
  ...
  "timezone-unix-timestamp-guide": [
    ...
    "/tools/calculate/time-converter",
    "/tools/calculate/unit-converter",
  ],
  ...
  "paypal-fees-complete-guide": [
    "/tools/ecommerce/paypal-fee-calculator",
    "/tools/ecommerce/stripe-vs-paypal-fee-calculator",
    "/tools/ecommerce/stripe-fee-calculator",
  ],
  "stripe-vs-paypal-fees-guide": [
    "/tools/ecommerce/stripe-vs-paypal-fee-calculator",
    "/tools/ecommerce/stripe-fee-calculator",
    "/tools/ecommerce/paypal-fee-calculator",
  ],
  "reverse-payment-fee-calculator-guide": [
    "/tools/ecommerce/paypal-fee-calculator",
    "/tools/ecommerce/stripe-fee-calculator",
    "/tools/ecommerce/stripe-vs-paypal-fee-calculator",
  ],
